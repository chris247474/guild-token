...
interface LollipopPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getCurrentHaloHaloPrice()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getCurrentHaloHaloPrice",
    values?: undefined
  ): string;
...
export class LollipopPool extends Contract {
  ...
  interface: LollipopPoolInterface;
  ...
  functions: {
    ...
    getCurrentHaloHaloPrice(overrides?: CallOverrides): Promise<[BigNumber]>;

    "getCurrentHaloHaloPrice()"(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
