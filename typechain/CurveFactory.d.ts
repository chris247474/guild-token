...
interface CurveFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "newCurve(string,string,address,address,uint256,uint256,address,address)": FunctionFragment;
...
export class CurveFactory extends Contract {
  ...
  functions: {
    ...
    "newCurve(string,string,address,address,uint256,uint256,address,address)"(
      _name: string,
      _symbol: string,
      _baseCurrency: string,
      _quoteCurrency: string,
