...
interface MockUsdUsdcAssimilatorInterface extends ethers.utils.Interface {
  functions: {
...
export class MockUsdUsdcAssimilator extends Contract {
  ...
  interface: MockUsdUsdcAssimilatorInterface;
