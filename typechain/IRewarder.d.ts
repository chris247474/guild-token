...
interface IRewarderInterface extends ethers.utils.Interface {
  functions: {
    "onRewardTokenReward(uint256,address,address,uint256,uint256)": FunctionFragment;
    "pendingTokens(uint256,address,uint256)": FunctionFragment;
  };

  encodeFunctionData(
    functionFragment: "onRewardTokenReward",
...
export class IRewarder extends Contract {
  ...
  functions: {
    ...
    "onRewardTokenReward(uint256,address,address,uint256,uint256)"(
      pid: BigNumberish,
      user: string,
      recipient: string,
      rewardTokenAmount: BigNumberish,
