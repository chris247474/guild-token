...
library Assimilators {
  ...
  function delegate(address _callee, bytes memory _data)
    internal
  ...
  function viewRawAmount(address _assim, int128 _amt)
    internal
    view
  ...
  function viewNumeraireBalance(address _assim)
    internal
    view
    returns (int128 bal_)
  {
  ...
  function intakeRaw(address _assim, uint256 _amt)
    internal
    returns (int128 amt_)
  {
  ...
  function intakeNumeraire(address _assim, int128 _amt)
    internal
